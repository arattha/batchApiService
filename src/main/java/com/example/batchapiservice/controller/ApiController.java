package com.example.batchapiservice.controller;


import com.example.batchapiservice.domain.ApiInfo;
import com.example.batchapiservice.domain.ProductVO;
...
public class ApiController {
    ...
    public String product1(@RequestBody ApiInfo apiInfo){
        List<ProductVO> productVOList = apiInfo.getApiRequestList()
                                        .stream()
                                        .map(item -> item.getProductVO())
                                        .collect(Collectors.toList());
        System.out.println("collect = " + productVOList);
